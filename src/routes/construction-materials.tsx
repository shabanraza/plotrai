...
const HUB = TOPIC_HUB_BY_PATH.get('/construction-materials')

export const Route = createFileRoute('/construction-materials')({
  component: ConstructionMaterialsHubPage,
  head: () => {
    if (!HUB) return {}
    return {
      meta: [
        ...
        { property: 'og:url', content: 'https://plotrai.in/construction-materials' },
        { property: 'og:type', content: 'website' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: 'https://plotrai.in/og/landing.png' },
      ],
      links: [canonicalLink('/construction-materials')],
      scripts: [
        articleLd({
          headline: HUB.title,
...
function ConstructionMaterialsHubPage() {
  if (!HUB) return null
